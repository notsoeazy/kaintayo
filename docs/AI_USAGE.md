* Used ChatGPT to brainstorm the app and get ideas for the tools/services to be used in the app.
* Used Claude to create docs/ and analyze the project stucture to set rules in DEV_GUIDE.md
