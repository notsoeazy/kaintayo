export const strings = {
  en: {
    ...
    profileScreen: {
      ...
      wishlistComingSoon: "Sry boss, wala ka pang gusto i-try",
      wishlistComingSoonDesc: "Hintay muna sa wishlist button",
  ...
  tl: {
    ...
    profileScreen: {
      ...
      tabTried: "Na-try ko na",
      tabWishlist: "Want to try",
      wishlistComingSoon: "Malapit na!",
      wishlistComingSoonDesc: "Makukuha ang tab na ito pagkatapos matapos ang details screen. Abangan!",
      triedEmptyTitle: "Wala ka pang na-try",
